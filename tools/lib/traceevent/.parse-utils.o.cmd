cmd_parse-utils.o := /work1/github-tomwei/test-module-arm/gcc-linaro-7.4.1-2019.02-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-gcc -Wp,-MD,./.parse-utils.o.d -Wp,-MT,parse-utils.o -g -Wall -fPIC -I. -I /work1/opensource/kernel/android-common/tools/include -D_GNU_SOURCE -D"BUILD_STR(s)=$(pound)s" -c -o parse-utils.o parse-utils.c
