cmd_plugin_sched_switch.o := /work1/github-tomwei/test-module-arm/gcc-linaro-7.4.1-2019.02-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-gcc -Wp,-MD,./.plugin_sched_switch.o.d -Wp,-MT,plugin_sched_switch.o -g -Wall -fPIC -I. -I.. -I /work1/opensource/kernel/android-common/tools/include -D_GNU_SOURCE -D"BUILD_STR(s)=$(pound)s" -c -o plugin_sched_switch.o plugin_sched_switch.c
