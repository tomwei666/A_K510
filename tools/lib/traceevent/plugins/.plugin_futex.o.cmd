cmd_plugin_futex.o := /work1/github-tomwei/test-module-arm/gcc-linaro-7.4.1-2019.02-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-gcc -Wp,-MD,./.plugin_futex.o.d -Wp,-MT,plugin_futex.o -g -Wall -fPIC -I. -I.. -I /work1/opensource/kernel/android-common/tools/include -D_GNU_SOURCE -D"BUILD_STR(s)=$(pound)s" -c -o plugin_futex.o plugin_futex.c

source_plugin_futex.o := plugin_futex.c
...
plugin_futex.o: $(deps_plugin_futex.o)
